...
const Captcha = ()=>{
  ...
  return (
    <div className={styles.Container}>
      ...
      <div className={styles.heading}>{num1} + {num2}</div>
      <input
        type="text"
      ...
      />
      <button onClick={generateCaptcha} className={styles.refresh}>Refresh</button>
      <button onClick={verifyCaptcha} className={styles.Submit}>Submit</button>
      <ToastContainer/>
    </div>
  );
}
